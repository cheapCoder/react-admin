...
| 开发服务器 | [http://localhost:4000](http://localhost:5000)               |
| ---------- | ------------------------------------------------------------ |
| 线上服务器 | [http://localhost:4000](http://localhost:5000)（真实场景不一样） |
 ...
 **除了 /login, 	/manage/img/upload**

例如： atguigu_token

atguigu_eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjVkNmEyYTU2OTZiODExMjEzYzI2Yjg3ZiIsImlhdCI6MTU2NzM4ODUwOCwiZXhwIjoxNTY3OTkzMzA4fQ.XF42Fq6mESxStnAVEF-bmYEfAHDCvPMb__wkwOkyeOk
...
## 2. 添加用户
 ...
 请求URL：
	http://localhost:4000/manage/user/add
...
## 3. 更新用户
 请求URL：
	http://localhost:4000/manage/user/update
...
## 4. 获取所有用户列表
 请求URL：
	http://localhost:4000/manage/user/list
...
## 5. 删除用户
 请求URL：
	http://localhost:4000/manage/user/delete
...
## 6. 获取分类列表
 请求URL：
	http://localhost:4000/manage/category/list
...
## 7. 添加分类
 请求URL：
    http://localhost:4000/manage/category/add
...
## 8. 更新品类名称
 请求URL：
    http://localhost:4000/manage/category/update
...
## 9. 根据分类ID获取分类
 请求URL：
    http://localhost:4000/manage/category/info
...
## 10. 获取商品分页列表
 请求URL：
    http://localhost:4000/manage/product/list
...
## 11. 根据Name/desc搜索产品分页列表
 请求URL：
    http://localhost:4000/manage/product/search?pageNum=1&pageSize=5&productName=T
...
## 12. 根据商品ID获取商品
 请求URL：
    http://localhost:4000/manage/product/info
...
## 13. 添加商品
 请求URL：
    http://localhost:4000/manage/product/add
...
## 14. 更新商品
 请求URL：
    http://localhost:4000/manage/product/update
...
## 15. 对商品进行上架/下架处理
 请求URL：
    http://localhost:4000/manage/product/updateStatus
...
## 16. 上传图片
 请求URL：
    http://localhost:4000/manage/img/upload
 ...
 返回示例：
    {
        ...
        "data": {
            ...
            "url": "http://localhost:4000/upload/image-1559466841118.jpg"
        }
    }

## 17. 删除图片
 请求URL：
    http://localhost:4000/manage/img/delete
...
## 18. 添加角色
 ...
 请求URL：
    http://localhost:4000/manage/role/add
...
## 19. 获取角色列表
 请求URL：
    http://localhost:4000/manage/role/list
...
## 20. 更新角色(给角色设置权限)
 请求URL：
    http://localhost:4000/manage/role/update
...
## 22.验证token 
 ...
 请求URL：
	http://localhost:4000/check_token
